...
import { User, Phone, Star, Award } from "lucide-react";
        ...
        <Card className="w-full max-w-md animate-fade-in-up">
          <CardHeader className="items-center text-center">
            <Avatar className="w-24 h-24 mb-4 border-4 border-primary">
              <AvatarImage src={mockUser.avatar} data-ai-hint={mockUser.dataAiHint} />
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center p-3 bg-muted/50 rounded-lg">
             ...
             <div className="flex items-center p-3 bg-muted/50 rounded-lg">
              <Award className="w-5 h-5 mr-4 text-primary" />
              <div>
                <p className="text-sm text-muted-foreground">Loyalty Tier</p>
                <p className="font-semibold">{mockUser.loyaltyTier} ({mockUser.loyaltyPercentage}%)</p>
              </div>
            </div>
             <div className="flex items-center p-3 bg-muted/50 rounded-lg">
              <Star className="w-5 h-5 mr-4 text-accent" />
              <div>
                <p className="text-sm text-muted-foreground">Bonus Balance</p>
                <p className="font-semibold text-accent">{mockUser.bonusBalance} points</p>
              </div>
            </div>
          </CardContent>
        </Card>
